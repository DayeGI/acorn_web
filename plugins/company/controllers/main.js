...
// util.inherits(Main, pb.BaseController);

// Main.prototype.render = function(cb) {
...
//                                 self.ts.registerLocal('company_site_name');
...
//                                         self.ts.load(path.join('main'), function(error, result) {
